...
class JobhaiService {
  static async getJobs(payload) {
    ...
    const headers = {
      ...
      'Authorization': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwYXlsb2FkIjp7InVzZXJfaWQiOjExMzM5MjI2LCJzdGF0dXMiOiJ2ZXJpZmllZCJ9LCJpYXQiOjE3MjU5NjYwMzcsImV4cCI6MTc1NzUwMjAzN30.GcbhP3Vi5jrx4Ee3mtOABRWuXRT8bzFdqRTC4phrXNQ', // Replace this with a valid token
  ...
  static async getJobDetails(id) {
    ...
    const headers ={
      ...
      'Accept-Encoding': 'gzip, deflate, br, zstd',
      'Accept-Language': 'en-US,en;q=0.9',
      'Authorization': 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwYXlsb2FkIjp7InVzZXJfaWQiOjExMzM5MjI2LCJzdGF0dXMiOiJ2ZXJpZmllZCJ9LCJpYXQiOjE3MjU5NjYwMzcsImV4cCI6MTc1NzUwMjAzN30.GcbhP3Vi5jrx4Ee3mtOABRWuXRT8bzFdqRTC4phrXNQ',
